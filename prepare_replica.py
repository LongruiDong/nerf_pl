# -*- coding:utf-8 -*-
"""
仿照prepare_phototourism.py 来生成replica训练数据
"""
import argparse
from datasets import ReplicaDataset, ReplicaGTDataset
import numpy as np
import os
import pickle
...
if __name__ == '__main__':
    ...
    dataset = ReplicaDataset(args.root_dir, 'train', args.img_downscale)
    # save img ids
